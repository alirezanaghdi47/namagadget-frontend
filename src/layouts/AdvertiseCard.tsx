  ...
  return (
    <Link href="/advertise" className="h-full w-full">
      <div className="flex h-[120px] w-full items-start justify-start gap-2 rounded-lg border border-solid border-secondary/10 bg-default p-2">
        ...
        <div className="dir-rtl flex h-full w-full flex-col items-start justify-start gap-2">
          <h2 className="line-clamp-2 text-wrap text-right text-sm font-bold text-default-foreground">
            ایکس33 کراس اتومات نقد/ X33 cvt
          </h2>
          ...
          <span className="line-clamp-1 flex items-center justify-start gap-1 text-xs text-secondary">در تهران</span>
        </div>
      </div>
    </Link>
  );
